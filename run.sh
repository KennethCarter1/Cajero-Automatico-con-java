...
# ============================================
# run.sh - Compila y ejecuta el proyecto Java
# ============================================
...
javac -cp "lib/mysql-connector-j-8.0.33.jar" -d build/classes \
    src/Conexion/*.java src/ventanas/*.java src/Principal/*.java
