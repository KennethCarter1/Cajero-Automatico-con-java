...
public class ventanaRetiro extends JFrame {
    ...
    public ventanaRetiro(String pinIngresado){
        ...
        btn_confirmacion.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                try {
                    ...
                    null,
                    "¿Seguro que quieres retirar este monto?",
                    "Confirmar deposito",
                    JOptionPane.YES_NO_OPTION
                );

                    if(verificacion == JOptionPane.YES_OPTION){
                        boolean verificar = validar.retirarDinero(pinIngresado, montoNuevo);
                    ...
                    JOptionPane.showMessageDialog(ventanaRetiro.this, "Ingrese un número válido", "Error", JOptionPane.ERROR_MESSAGE);
                    txtMonto.setText("");
                }
